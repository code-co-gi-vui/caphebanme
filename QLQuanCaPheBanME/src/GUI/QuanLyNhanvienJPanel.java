...
NhanVien nv = Auth.user;
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            if (nv.isVaiTro()) {
            if (checkNull() && checkEmail() && checkSDT() && checkSame() && checkSameAccount() && checkLength() && checkDinhDang()) {
                this.insert();
            }
        }else{
            ...
            JOptionPane.showMessageDialog(this, "Chức năng này lỗi vui lòng liên hệ cho thành viên huy!");
        }
...
void init() {
    ...
    private boolean checkDinhDang() {
        ...
        String check = "^[a-z A-Z]{1,50}$";
        if (tk.matches(check)) {
            return true;
        } else {
            JOptionPane.showMessageDialog(this, "Sai định dạng tài khoản");
            return false;
        }
    }
}
