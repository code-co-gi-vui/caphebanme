...
//        fillcomboboxEvent();
    ...
    private void initComponents() {
        ...
        btngiahan.setBackground(new java.awt.Color(255, 255, 255));
...
//                for (int i = 0; i < tblSanPhamgiamchitiet.getRowCount(); i++) {
    ...
    BUL.SerGiamGia inserts = new SerGiamGia();
    BUL.SerGiamGia updates = new SerGiamGia();
    BUL.SerGiamGia deletes = new SerGiamGia();
