...
public class ChuyenBanJDialog extends javax.swing.JDialog {
    ...
    private void btnChuyenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChuyenActionPerformed
        ...
        List<BanChitiet> listbanchon = DAOBANCT.selectByIdBan(ban.getIdBan());
        if (!listbanchon.isEmpty()) {
            List<BanChitiet> listbanchonlk = DAOBANCT.selectByIdHD(listbanchon.get(0).getID_HoaDon());
                for (BanChitiet banChitiet : listbanchonlk) {
                    ...
                    BanChitiet bctt = DAOBANCT.selectById(ban.getIdBan(), idHoaDon);
                    banchitiet.setThoidiemCoNguoi(bctt.getThoidiemCoNguoi());
