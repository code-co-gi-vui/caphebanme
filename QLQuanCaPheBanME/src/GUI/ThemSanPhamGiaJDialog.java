 ...
 * @author HP
 */
public class ThemSanPhamGiaJDialog extends javax.swing.JDialog {
    ...
    public ThemSanPhamGiaJDialog(java.awt.Frame parent, boolean modal, int magiamgia, Date ngaybatdau) {
        super(parent, modal);
        initComponents();
...
//        txtidchitietgg.setText(magg);
    ...
    public static void setMasp(String masp) {
        ThemSanPhamGiaJDialog.masp = masp;
    }
